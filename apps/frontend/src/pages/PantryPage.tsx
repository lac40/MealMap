...
const PantryPage = () => {
  ...
  if (isLoadingPantry) {
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-foreground mb-6">Pantry</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Pantry</h1>
      ...
      {pantryItems.length === 0 ? (
        <div className="bg-muted rounded-2xl p-12 text-center border border-border">
          ...
          <p className="text-foreground text-lg mb-4">Your pantry is empty</p>
          <p className="text-muted-foreground mb-6">Start adding ingredients to track your inventory</p>
          <Button onClick={() => handleOpenForm()}>Add Your First Item</Button>
        </div>
      ) : (
        <div className="space-y-6">
          {Object.entries(itemsByCategory).map(([categoryName, items]) => (
            <div key={categoryName} className="bg-muted rounded-2xl shadow-md border border-border">
                    ...
                    >
                      ...
                      <div className="flex gap-2 ml-2">
                        <button
                          ...
                          className="p-2 text-muted-foreground hover:text-primary-600 dark:hover:text-primary-400 rounded-lg hover:bg-muted transition-colors"
                        ...
                        <button
                          ...
                          className="p-2 text-muted-foreground hover:text-red-600 dark:hover:text-red-400 rounded-lg hover:bg-muted transition-colors"
